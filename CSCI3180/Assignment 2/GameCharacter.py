...
class GameCharacter(metaclass=ABCMeta):
    ...
    #TODO: name getter (done)
    def getName(self):
        return self._name
    
    #TODO: row getter (done)
    def getRow(self):
        return self._row

    #TODO: col getter (done)
    def getCol(self):
        return self._col
    
    #TODO: active getter and setter (done)
    def getActive(self):
        return self._active
    ...
    #TODO: occupying getter and setter (done)
    ...
    def display(self):
        # TOD: return _color followed by _character for displaying (done)
        output_string = self._color + self._character
...
class Player(GameCharacter):
    ...
    #TODO: hp getter and setter (done)
    def getHP(self):
        return self._hp
    ...
    #TODO: oxygen getter and setter (done)
    def getOxygen(self):
        return self._oxygen

    def setOxygen(self, o):
        self._oxygen = o
    ...
    def act(self, map):
        ...
        while next_cell == None:
            ...
            if (next_cell != None and next_cell.set_occupant(self)):
                ...
                self._oxygen -= self._occupying.getHours()
                self._occupying.remove_occupant()
                self.setOccupying(next_cell)
            else:
                next_cell = None
    ...
    def interact_with(self, comer):
        if comer._name == 'Goblin':
            print('\033[1;31;46mPlayer meets a Goblin! Player\'s HP - %d.\033[0m' %(comer._damage))
             # TODO: interact_with method (done)
            self._hp -= comer.getDamage()
...
class Goblin(GameCharacter):
    ...
    #TODO: damage getter (done)
    def getDamage(self):
        return self._damage

    def act(self, map):
        # TODO: act method of a Goblin 
        # get the next cell according to _actions and _cur_act (done)
    ...
    def interact_with(self, comer):
        if comer._name == 'Player':
            ...
            #       return whether the Player successfully enter the cell (done)
            comer.setHP(comer.getHP() - self._damage)
